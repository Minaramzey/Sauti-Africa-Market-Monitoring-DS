...
class TimeSeries():
    ...
    def extract_data(self, market, product, source, sale_type):
        ...
        """        
        ts_name = sale_type + ', product: ' + product + ', market: ' + market + ', source: ' + source
